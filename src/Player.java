...
public class Player implements Observer {
    ...
    private Storage centralStorage; //central storage
    ...
    public Player(String playerName, double carryCapacity, Inventory sInventory) {
        ...
        centralStorage = new Storage("Own Storage", sInventory);
        storageView = new Inventory(); //player own view of storage, initialized with empty
        setStorageView(inventory);
        centralStorage.addObserver(this);
    }

    public void setStorageView(Inventory storageInventory) {
        //storageView = centralStorage.getInventory().copy();
    ...
    public void update(){
        ...
        setStorageView(centralStorage.getInventory());
        System.out.println("The inventory is updated!");
    }
}
